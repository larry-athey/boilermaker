...
**10. Set SSR PWM duty width** - This option is only displayed if you are using an SSR rather than an SCR. By default, this controller uses a 0.2 Hz PWM for an SSR. This means that the duty width is 2.5 seconds. You can reduce this to 1 second or increase it to 5 seconds. The Airhead controller uses 2.5 seconds due to the slow reaction time of its 700 watt heating element. The 1500 watt heating element in my Still Spirits boiler is incredibly fast, so I have this reduced all the way down to 1 second. A friend of mine uses 240 volt 4000 watt water heater elements and he has his cranked up to 4 seconds due to their slow reaction time when running them at 120 volts. You will just have to experiment with your system to find the magic number for your elements.
