...
_**NOTE:** Firstly, heating **anything** from the bottom-up has **never** had a linear result at all levels. Secondly, no boiler controller can magically save you from yourself. If you don't have a basic understanding of thermo dynamics and fluid dynamics, you will always blame the boiler and/or controller for your unrealistic expectations. Lastly, even the most sophisticated tools can be used incorrectly._
