...
_**PRO-TIP:** The operation mode **Cruise Then Brew** performs the above mode shift procedure automatically when the target temperature is reached. You can also use the progressive temperature feature to automatically adjust the target temperature up to your goal over 1 hour._
