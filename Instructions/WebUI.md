...
**Target Temp:** As the name implies, this is the target temperature that you want to shoot for. Everything is done in Celcius at the hardware level, so you need to enter your choice in Celcius here. The upper limit is 260C/500F, and will require you to use a thermocouple instead of a DS18B20 for anything over 125C/257F. This will allow you to use a Boilermaker to control an electric grill or other high temperature appliance.
