...
5. **PID Auto Tune** should be used with care because this will make your Boilermaker completely unresponsive until the tuning procedure is complete, the only output is via the serial connection. You only have 15 seconds to cancel it if you accidentally start it. Otherwise, you will need to disconnect the power and plug it back in. There are no adjustment parameters for this mode. The time this takes is completely up to your boiler's physical attributes. Your boiler needs to be full of water, it will be raised to 66C/150F before the tuning begins which takes 10 to 20 minutes.
