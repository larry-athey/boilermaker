...
2. **Temperature Cruise** will honor a target temperature and manage the power in order to maintain that temperature using high thermal velocity. This is the same temperature management method used in the [Airhead](https://github.com/larry-athey/airhead) upgrade for Air Stills. The technical definition of this mode would be a PI controller.
