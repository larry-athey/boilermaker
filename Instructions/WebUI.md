...
In **Constant Power** mode, you naturally have a progressive temperature ramp which will continue to rise. This feature allows you to create that ramp with an actual end point that no longer continues to rise, but you can't precisely target that end point. In **Temperature Cruise** and **Brewing/Fermentation** modes with progressive temperature enabled, you actually can target the end point.
