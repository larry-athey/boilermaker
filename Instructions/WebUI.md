...
The second WebUI card displays live data from the Boilermaker. This is updated at a random time period anywhere from 4.5 to 5.5 seconds, there is not an actual continuous data stream between your cell phone and the Boilermaker, your phone only requests data updates from it at random times.
