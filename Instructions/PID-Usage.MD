...
In the Temperature Cruise mode (PI mode), the **Change Wait** and **Adjustment Rate** are equal to the **P** parameter and the **Deviation Rate** is equal to the **I** parameter.
