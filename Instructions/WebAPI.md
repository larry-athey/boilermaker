...
**/?data_1=** - Primarily used by the WebUI to set the target temperature of the Boilermaker. The value passed here is the temperature in Celcius and must be a whole or floating point number between 0 and 260. If you are using this Boilermaker with the **RPi Smart Still** this value will be set to match the lower boiler range temperature when you start a run, and will be dynamically adjusted if you have the Progressive Temperature feature enabled.
