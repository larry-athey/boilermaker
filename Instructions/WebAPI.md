...
**/?data_2=** - Primarily used by the WebUI to set the startup power of the Boilermaker. Adjusting this during an active run does not change the current power level, you will need to restart the run to change the current power level.
