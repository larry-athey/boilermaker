...
_**NOTE:** Assembled and tested units for those not comfortable with building this from scratch will soon be available from [my website](https://panhandleponics.com/technology-assisted-distillation/). There will be a short lead time on all orders to allow for 3D printing of the 3D models._<br>
