...
The [RPi Smart Still](https://github.com/larry-athey/rpi-smart-still) system fully supports the Boilermaker in all three operating modes. It can actually run the Boilermaker the same as an SCR controller, but without the need for a stepper motor.
