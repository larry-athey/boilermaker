...
The icing on the cake with this PWM and SSR combination is that it doesn't contribute to premature heating element failure as with the high-speed on/off switching in SCR controllers. SCR phase-angle control generates harmonics _(distortions in the AC sine wave)_ which can lead to uneven current distribution, physical vibration, and stress within a heating element. The Boilermaker is actually better for your boiler's longevity!
