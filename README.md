...
By default, this controller uses a DS18B20 temperature sensor since it has the necessary range for use with a boiler _(125C/257F maximum)_. If you intend to use the controller to run an electric smoker, oven, or slow cookier, you will need to use a Type-K thermocouple and a MAX-6675 amplifier. The source supports both types, you just decide which one to use at compile time.
